...
export const Testimonials: React.FC = () => {
  const testimonials = [
    ...
    },
    {
      ...
      content: "Tracking minutes spent has been incredibly helpful. Our live sessions now generate 40% of our monthly revenue. The platform is intuitive and effective.",
      rating: 5
    },
    {
